  ...
  const portfolioData = {
    ...
    projects: [
      ...
      },
      {
        ...
        description: "Combining Raspberry Pi with high-resolution cameras, real-time streaming capabilities, and sensor modules allows users to observe and navigate their surroundings in real-time with an accuracy of 98%",
      },
      {
